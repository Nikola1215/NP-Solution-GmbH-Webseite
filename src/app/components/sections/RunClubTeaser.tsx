...
import RunClubInfoBlocks from "../RunClubInfoBlocks";
  ...
  return (
    <section className="py-16 px-6 border-b border-white/5 bg-gradient-to-br from-[#1a0f05] via-[#0c0c0c] to-[#0c0c0c]">
      <div className="max-w-6xl mx-auto">
        <FadeUp>
          <div className="rounded-2xl border border-brand/20 bg-[#111]/60 px-8 py-10 md:px-12 md:py-12">
            ...
            <Link
              href="/run-club"
              className="mt-8 flex w-full items-center justify-center gap-2 bg-brand hover:bg-brand-hover text-white font-semibold px-6 py-4 rounded-xl transition-all hover:shadow-[0_0_40px_-8px_#FF5F00]"
            >

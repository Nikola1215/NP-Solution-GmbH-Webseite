...
const STEPS: { title: string; desc: string; icon: React.ReactNode }[] = [
  ...
  {
    title: "Abstimmen",
    desc: "Vorgehen, Schnittstellen und Umfang gemeinsam festlegen.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Umsetzen",
    desc: "Arbeiten zuverlässig, sauber und praxisnah durchführen.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Abschliessen",
    desc: "Funktion prüfen, Arbeiten dokumentieren und übergeben.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
